...
#define OLED_SCL    PCout(3)
#define OLED_SDA  	PCout(2)
#define OLED_RST  	PCout(1)
#define OLED_DC   	PCout(0)
...
void OLED_Init(void)
{
	  //RCC->AHB1ENR|=1<<6;//使能PORTF时钟 
	  //GPIO_Set(GPIOG,PIN2|PIN3|PIN4|PIN5|PIN6,GPIO_MODE_OUT,GPIO_OTYPE_PP,GPIO_SPEED_100M,GPIO_PUPD_PU);
//	  PGout(6)=1;
//		PGout(5)=1;
//		PGout(4)=0;
//		PGout(3)=1;
...
//	    RCC->AHB1ENR|=1<<3;
//	    RCC->AHB1ENR|=1<<4;
//	    GPIO_Set(GPIOG,PIN9,GPIO_MODE_OUT,GPIO_OTYPE_PP,GPIO_SPEED_100M,GPIO_PUPD_PU);
//	    GPIO_Set(GPIOD,PIN8|PIN10,GPIO_MODE_OUT,GPIO_OTYPE_PP,GPIO_SPEED_100M,GPIO_PUPD_PU);
//	    GPIO_Set(GPIOE,PIN12|PIN14,GPIO_MODE_OUT,GPIO_OTYPE_PP,GPIO_SPEED_100M,GPIO_PUPD_PU);

	RCC->APB2ENR|=1<<4;    //使能PORTE时钟	
	   	 
	GPIOC->CRL&=0XFFFF0000; 
	GPIOC->CRL|=0X00003333;//PB.5 推挽输出   	 
...
{
	temp=abc;
	sprintf((char*)i_sc,"%.0f",temp);
	OLED_P6x8Str(x,y,i_sc);
}
